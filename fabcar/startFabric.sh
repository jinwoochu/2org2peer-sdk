...
echo "-----------------------------------------"
docker exec -e "CORE_PEER_LOCALMSPID=Org1MSP" -e "CORE_PEER_MSPCONFIGPATH=/etc/hyperledger/msp/org1/users/Admin@org1.example.com/msp" -e "CORE_PEER_ADDRESS=peer0.org1.example.com:7051" cli peer channel join -b $CHANNEL_NAME.block

# Join peer0.org2.example.com to the channel.
echo "-----------------------------------------"
echo "Join peer1.org1.example.com to the channel."
echo "-----------------------------------------"
docker exec -e "CORE_PEER_LOCALMSPID=Org2MSP" -e "CORE_PEER_MSPCONFIGPATH=/etc/hyperledger/msp/org2/users/Admin@org2.example.com/msp" -e "CORE_PEER_ADDRESS=peer0.org2.example.com:7051" cli peer channel join -b $CHANNEL_NAME.block
